...
var Game = (function () {
    ...
    Game.prototype.acceptPlayers = function (players) {
        var _this = this;
        players.forEach(function (player) { return _this.acceptPlayer(player); });
    };
    Game.prototype.acceptPlayer = function (player) {
    ...
    Game.prototype.switchRoles = function (player1, player2) {
